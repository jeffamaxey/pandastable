...
def tableapp_logo():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhAAEAAcZxAAAAAAcABxQAKxUALRsFAyUAJCQAJycAJiQIACYKACgO' +
...
def delete():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZvALdKK7hKKrpLLrhOLrxLML5PNrxQMr1RNb5TOMFNM9BP' +
...
def plot_clear():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPedAGVCPXZsJXsueXwzfH04f2pBbWhTe6pJB6lMCblFA7tC' +
...
def fit():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPYAADd1LTh1K/8CBv0NEfwOEvsWGvsXG/kZHPkhJPcrLvkq' +
...
def refresh():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPYAACNhHyRjICVlIidmIyloJCprJixtJzJ0LDN2Ljd7Mjp+' +
...
def transpose():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPYAACxsJyxtKC1uKC1uKS9xKzFzLDd7MTl9Mzt/NT6EOEGH' +
...
def melt():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAMZnACxsJy9wKi9xKzJ1LTN2LjV4LzV4MDZ5MDh8Mjp+ND6E' +
...
def pivot():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAMZQACFfHiNiICRiICZlIidmIylpJSprJixtKC5vKTByKzJ0' +
...
def aggregate():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAMZbACFfHiNiICZlIilpJSxtKC1sKS5vKTBwLDJ0LTN1LzV4' +
...
def merge():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZlADyANT6DN0CGOUKIO0eGQ0+ZR1CQSlGbSVOeS1ebUFia' +
...
def table_multiple():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZbAHy+doDBeoTDfkJ3u1KEw1SGxFWGxlaHx12KxVmKyF+P' +
...
def filtering():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPcAAMh/M81/OIF7c9mYP/LSOLmIScWIR9WOSMqTQMmWQ82X' +
...
def importcsv():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAOe1ACpgtyxity5kth57AyxltC5luS9lujBluiJ7DjBmuiN6' +
...
def excel():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAOenACpgtyxity1kuS5kuS5luTN0GS9lujBlujN1GTN1GjN1' +
...
def add():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZ2ADSBLDSCLDeELzmFMDyHMj2INECJNkKNNkKLOEOPOESM' +
...
def cross():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPYAAOQiJOYqLOktL+ovMekyNes0Nuw8Pu49P+0+QO0/QfE/' +
...
def accept():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPeGAB1sGh5uGh5wGh5xGh9xGx5zGh94Gx56Gx96Gx5/Gx+D' +
...
def calculate():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZaAHJycnp6en5+fttYUuh0c01yp1Z7sGSLwWaNw2eNw2eP' +
...
def table_delete():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZ5ALlEA7lFA7xCBLxDBbxNBbxWHb1XHrhWIr5bKN1kAeFo' +
...
def function():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPUAACYmJikpKSoqKi0tLS4uLi8vLzExMTIyMjQ0NDU1NTc3' +
...
def copy():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZtAEJzxUR0xUV1xkV1x0d5x0h9w0l5x0p5x0V1yEZ1yEt5' +
...
def paste():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPYAAEZGRkhISElJSUpKSkxMTE9PT1JSUlNTU1VVVVZWVlhY' +
...
def tilevertical():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZrAEBZl0Bal0FbmEVenUZin0pnoUhlo0tnpUtpo01tpU1q' +
...
def tilehorizontal():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZTAEBZl0Bal0Jbl0NdmUNemkVgnEVgnUZinUlln0pnpEtp' +
...
def expand_col():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZvADp+NESHPUWGPkKIO1SOUF6VWVyiVF6rVF+hWGGiWmSv' +
...
def contract_col():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPZmACBeHSVlIixtJzp+NDx/N1SVTV2aV16XWVWhTVugU16p' +
...
def font():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPYAACtNwytQxDFVxjNhzDdjzDdmzDdnzTVpzzhozjlozjpq' +
...
def color_swatch():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPMAAP5va1DMbf+qc/DVZ1h6sP93sWCw69Drstmb3QAAAAAA' +
...
def zoom_in():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPQYADdrGTlsG0x7MVOMKFePLVmEQF2HRGaOT2iPUW6UWIGr' +
...
def zoom_out():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPQbALlEA7lFA7xCBL1NBMBNDsNXGt1kAeFoA+52AOp5Bfh2' +
...
def save():
     return tk.PhotoImage(
         format='gif',
         data='R0lGODlhEAAQAPcAAIjAYjFgpjFgpzFgqDFhqDJhqDJhqTJhqjJiqjJiqzJj' +
